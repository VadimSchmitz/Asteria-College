      ...
      <div>
        ...
        >
          ...
          <template v-slot:modal-footer="{ok, cancel}">
            <b-button size="m" variant="danger" @click="removeEvent" v-if="!addingMode">Delete</b-button>
            <b-button size="m" variant="secondary" @click="cancel()">Cancel</b-button>
            <b-button size="m" variant="success" @click="ok()">Save</b-button>
          </template>
        </b-modal>
      </div>
      <div class="col-md-8">
