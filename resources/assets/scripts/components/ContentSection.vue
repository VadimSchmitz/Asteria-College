                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="chart">
                                            <!-- Sales Chart Canvas -->
                                            <canvas height="180" id="salesChart" style="height: 180px;"></canvas>
                                        </div>
                                        <!-- /.chart-responsive -->
                                    </div>
                                    <!-- /.col -->
                    ...
                    <div class="col-md-8">
                                ...
                                <div class="card direct-chat direct-chat-warning">
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools">
                                            ...
                                            <button class="btn btn-tool" data-card-widget="remove" type="button"><i
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="users-list clearfix">
                                            <li>
                                                <img alt="User Image" src="assets/img/user1-128x128.jpg">
                                                <a class="users-list-name" href="#">Alexander Pierce</a>
                                                <span class="users-list-date">Today</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user8-128x128.jpg">
                                                <a class="users-list-name" href="#">Norman</a>
                                                <span class="users-list-date">Yesterday</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user7-128x128.jpg">
                                                <a class="users-list-name" href="#">Jane</a>
                                                <span class="users-list-date">12 Jan</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user6-128x128.jpg">
                                                <a class="users-list-name" href="#">John</a>
                                                <span class="users-list-date">12 Jan</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user2-160x160.jpg">
                                                <a class="users-list-name" href="#">Alexander</a>
                                                <span class="users-list-date">13 Jan</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user5-128x128.jpg">
                                                <a class="users-list-name" href="#">Sarah</a>
                                                <span class="users-list-date">14 Jan</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user4-128x128.jpg">
                                                <a class="users-list-name" href="#">Nora</a>
                                                <span class="users-list-date">15 Jan</span>
                                            </li>
                                            <li>
                                                <img alt="User Image" src="assets/img/user3-128x128.jpg">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer clearfix">
                                <a class="btn btn-sm btn-info float-left" href="javascript:void(0)">Place New Order</a>
                                <a class="btn btn-sm btn-secondary float-right" href="javascript:void(0)">View All
                                    Orders</a>
                            </div>
                            <!-- /.card-footer -->
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        Xbox One Console Bundle with Halo Master Chief Collection.
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a class="product-title" href="javascript:void(0)">PlayStation 4
